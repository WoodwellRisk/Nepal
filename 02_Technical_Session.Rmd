...
### Day 2 {-}
Before the session, download the practice data sets for Technical Session Day Two.

**Module 1a***	Using daily data: Projecting extreme heat days (Darcy Glenn)

* Review projection methodology concept

* Wet-bulb temperature: Heat & humidity measurements that can be related to health
...
* Precipitation: Threshold for extreme is set at the top 5% of rainy/snowy days
...
* Maximum temperature: Thresholds as seen in the module, but now with daily data
